...
const Sidebar = ({ collapsed }: Props) => {
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 hidden h-screen flex-col border-r bg-popover py-6 backdrop-blur transition-all duration-300 lg:flex",
    ...
    >
      ...
      <div
        className={cn(
          "rounded-3xl border bg-muted/40 p-4",
          collapsed ? "opacity-0" : "opacity-100"
        )}
      >
        <h3 className="text-sm font-semibold">Track smarter 💸</h3>

        <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
          Stay on top of your expenses and understand where your money goes
          every month.
        </p>
      </div>
    </aside>
